export default function TermsAndConditionsPage() {
  return (
    <main className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto px-50 py-48">
      ...
      <p>
        ...
        <strong>PrimeWave.inc</strong>, whose registered/operational office is
        CHALIL 12th Mile PALA Kottayam KERALA 686577. "you", “your”, "user”,
      ...
      <ul>
        ...
        <li>
          ...
          document without PrimeWave.inc’s prior written consent.
        </li>
        <li>
