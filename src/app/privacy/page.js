export default function PrivacyPolicyPage() {
  return (
    <main className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto px-54 py-48">
      <h1>Privacy Policy</h1>
      <p>
        <strong>Last updated on Jun 29th 2025</strong>
      </p>

      <p>
        This privacy policy sets out how <strong>PrimeWave.inc</strong> uses and
        protects any information that you give PrimeWave.inc when you visit
        their website and/or agree to purchase from them.
      </p>

      <p>
        PrimeWave.inc is committed to ensuring that your privacy is protected.
      ...
      <p>
        PrimeWave.inc may change this policy from time to time by updating this
      ...
      <p>
        ...
        or incomplete, please write to CHALIL 12th Mile PALA Kottayam KERALA
        686577 or contact us as soon as possible. We will promptly correct any
        information found to be incorrect.
      </p>

      <p className="text-sm italic text-gray-500">
        Disclaimer: The above content is created at JOSE CHALIL SEBASTIAN's sole
